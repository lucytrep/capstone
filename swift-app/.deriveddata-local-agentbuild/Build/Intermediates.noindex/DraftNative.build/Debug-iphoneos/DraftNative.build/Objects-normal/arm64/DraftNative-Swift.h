...
#ifndef DRAFTNATIVE_SWIFT_H
#define DRAFTNATIVE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DraftNative",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Messages and several system share targets attach a <em>file URL</em> reliably; a raw <code>UIImage</code> plus a caption <code>String</code>
...
SWIFT_CLASS("_TtC11DraftNative25ShareableLibraryImageItem")
@interface ShareableLibraryImageItem : NSObject <UIActivityItemSource>
...
SWIFT_CLASS("_TtC11DraftNative16SpeechRecognizer")
